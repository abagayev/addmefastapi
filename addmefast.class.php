...
class AddMeFast {
     ...
     * @return associative_array containing all site as stdClass Object
     */
    ...
    // this is JSON_UNESCAPED_UNICODE analogue for using UTF-8 on PHP < 5.4
    ...
    private static $site_types = array(
        1 	=> 'facebook/likes',
        18 	=> 'facebook/share',
